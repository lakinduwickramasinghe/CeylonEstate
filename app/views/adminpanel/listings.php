    ...
    <main class="flex-1 p-8">
        ...
        <div class="mb-6">
            <input type="text" id="searchInput" placeholder="Search listings..." class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1A5C38]">
        </div>
