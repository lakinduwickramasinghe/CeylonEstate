...
<body class="flex flex-col min-h-screen bg-gray-100">
    ...
    <section class="py-12 sm:py-16 text-center relative">
        <div class="container mx-auto px-4 relative z-10">
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-4 sm:mb-6">Search Properties for Sale</h2>
            <div class="bg-white text-black p-4 rounded-lg shadow-lg max-w-3xl sm:max-w-4xl mx-auto flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                <form action="/ceylonestatefinal/public/search/forsale" method="GET" class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 w-full">
